...
default_downloaders = [
    ...
    Downloader(
        ...
        "downloaders.torrent",
        "search",
        "url, torrent_url=https://thepiratebay.party/search, metadata_path=downloader_path, torrent_directory=output_directory, torrent_mode=magnet",
    ),
    Downloader(
        "torrent_info",
        os.path.join(DOWNLOADER_METADATA_DIR, "torrent_default.json"),
        "downloaders.torrent",
        "search",
        "url, torrent_url=https://thepiratebay.party/search, metadata_path=downloader_path, torrent_directory=output_directory, torrent_mode=info",
    ),
    Downloader(
        "torrent_extract",
        os.path.join(DOWNLOADER_METADATA_DIR, "torrent_default.json"),
        "downloaders.torrent",
        "search",
        "url, torrent_url=https://thepiratebay.party/search, metadata_path=downloader_path, torrent_directory=output_directory, torrent_mode=extract",
    ),
    Downloader(
        "kat",
        os.path.join(DOWNLOADER_METADATA_DIR, "torrent_default.json"),
        "downloaders.torrent",
        "search",
        "url, torrent_url=https://kickasstorrents.to/usearch, metadata_path=downloader_path, torrent_directory=output_directory, torrent_mode=magnet",
    ),
    Downloader(
        "piratebay",
        os.path.join(DOWNLOADER_METADATA_DIR, "torrent_default.json"),
        "downloaders.torrent",
        "search",
        "url, torrent_url=https://thepiratebay.org/search.php?q=, metadata_path=downloader_path, torrent_directory=output_directory, torrent_mode=magnet",
    ),
]
